...
with st.sidebar:
    ...
    if st.button("🔍 Analisis Putaran Terbaik"):
        ...
        if total_data_saat_ini < 30:
            ...
            # ==== PERBAIKAN: Logika di sini disederhanakan agar tidak membatalkan dirinya sendiri ====
            st.session_state.run_putaran_analysis = True
            st.session_state.prediction_data = None # Hapus hasil prediksi utama
            st.rerun() # Jalankan ulang script untuk memulai analisis
...
# --- Logika & Tampilan Analisis Putaran Terbaik ---
